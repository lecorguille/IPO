...
2. Install the IPO R library and its dependencies using conda `conda install r-ipo`

Note: if you want to set a dedicated conda environment for SARTools, use `conda create -n ipo r-ipo` and follow the instructions to activate it.
